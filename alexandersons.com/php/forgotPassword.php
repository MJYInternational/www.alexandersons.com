...
<!-- Required meta tags -->
  <meta charset="utf-8">
  <title>Alexander &amp; Sons | Forgot Password</title>
      ...
      <header>
        <div class="jumbotron d-flex justify-content-center">
          <div id="jumbopacity">
            ...
            <div id="serviceMenu">
              <div class="row">
                <div class="col-12 text-center loginBubble mt-auto">
                  <div class="bubbleContent">
                      <h2 class="font-md-lg mt-3 mb-2"> <span class="text-primary">Recover Password</span></h2>
                      <ul style="font-size: 1.2rem; font-family: 'Montserrat', sans-serif;">
                        <li>
                          <p style="font-size: 1.2rem; font-family: 'Montserrat', sans-serif;">Type Email Below, and select &ldquo;Recover&nbsp;Account&rdquo;</p>
                        </li>
                        <li>
                          <p style="font-size: 1.2rem; font-family: 'Montserrat', sans-serif;">Check email for password reset link</p>
                        </li>
                        <li>
                          <p style="font-size: 1.2rem; font-family: 'Montserrat', sans-serif;">Click secure link to reset password</p>
                        </li>
                      </ul>
                            ...
                            <div class="form-group row">
                              <div class="col-11 col-lg-9 col-xl-9 ml-auto mr-auto">
                                  ...
                                  <small id="passwordHelpInline" class="text-muted">
                                      <a href="../login.html"><p class="underlined mt-2 mb-2" style="font-size: 110%;">Return To login</p></a>
                                      </small>
                              </div>
                          </div>
